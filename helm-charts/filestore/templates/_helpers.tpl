...
app.kubernetes.io/name: {{ include "filestore.name" . }}
...
*/}}
{{- define "filestore.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "filestore.fullname" .) .Values.serviceAccount.name }}
{{- else }}
